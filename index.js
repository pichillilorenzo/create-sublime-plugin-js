...
module.exports = {
  ...
  eventListenerList: require('./jslib/eventListenerList.js'),
  ViewEventListener: require('./jslib/ViewEventListener.js'),
  viewEventListenerList: require('./jslib/viewEventListenerList.js')
}