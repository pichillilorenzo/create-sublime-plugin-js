...
class Window {
  ...
  */
   ...
   */
  open_file (file_name /*: string*/, flags /*: ?number*/ = 0, step /*: ?StepObject*/) /*: Promise<View>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].open_file("""${file_name}""", ${flags})`, true, step, (result, resultObject) => {
      return new View(resultObject)
    })
  }
   ...
   */
  find_open_file (file_name /*: string*/, step /*: ?StepObject*/) /*: Promise<View | null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].find_open_file("""${file_name}""")`, true, step, (result, resultObject) => {
      console.log(result)
   ...
   */
  active_sheet (step /*: ?StepObject*/) /*: Promise<Sheet>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_sheet()`, true, step, (result, resultObject) => {
   ...
   * Returns the currently focused sheet.
   */
  active_view (step /*: ?StepObject*/) /*: Promise<View>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_view()`, true, step, (result, resultObject) => {
      return new View(resultObject)
    })
  }
   ...
   */
  active_sheet_in_group (group /*: number*/, step /*: ?StepObject*/) /*: Promise<Sheet>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_sheet_in_group(${group})`, true, step, (result, resultObject) => {
      return new Sheet(resultObject)
    })
  }
   ...
   */
  active_view_in_group (group /*: number*/, step /*: ?StepObject*/) /*: Promise<View>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_view_in_group(${group})`, true, step, (result, resultObject) => {
      return new View(resultObject)
    })
  }
  ...
  sheets (step /*: ?StepObject*/) /*: Promise<Array<Sheet>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].sheets()`, false, step, (result, resultObject) => {
      let sheets = []
      for (let sheet of resultObject.value) {
        sheets.push(new Sheet(sheet))
      }
      return sheets
    })
  }
  ...
  sheets_in_group (group /*: number*/, step /*: ?StepObject*/) /*: Promise<Array<Sheet>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].sheets_in_group(${group})`, false, step, (result, resultObject) => {
      let sheets = []
      for (let sheet of resultObject.value) {
        sheets.push(new Sheet(sheet))
      }
  ...
  views (step /*: ?StepObject*/) /*: Promise<Array<View>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].views()`, false, step, (result, resultObject) => {
      let views = []
  ...
  views_in_group (group /*: number*/, step /*: ?StepObject*/) /*: Promise<Array<View>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].views_in_group(${group})`, false, step, (result, resultObject) => {
      let views = []
      for (let view of resultObject.value) {
        views.push(new View(view))
      }
  ...
  num_groups (step /*: ?StepObject*/) /*: Promise<number>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].num_groups()`, false, step)
  }
  ...
  active_group (step /*: ?StepObject*/) /*: Promise<number>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_group()`, false, step)
  }
  ...
  focus_group (group /*: number*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].focus_group(${group})`, false, step)
  }
  ...
  focus_sheet (sheet /*: Sheet*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].focus_sheet(${config.variableMappingName}["${sheet.self.mapTo}"])`, false, step)
  }
  ...
  focus_view (view /*: View*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].focus_view(${config.variableMappingName}["${view.self.mapTo}"])`, false, step)
  }
  ...
  get_sheet_index (sheet /*: Sheet*/, step /*: ?StepObject*/) /*: Promise<[number, number]>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].get_sheet_index(${config.variableMappingName}["${sheet.self.mapTo}"])`, false, step)
  }
  ...
  set_sheet_index (sheet /*: Sheet*/, group /*: number*/, index /*: number*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_sheet_index(${config.variableMappingName}["${sheet.self.mapTo}"], ${group}, ${index})`, false, step)
  }
  ...
  get_view_index (view /*: View*/, step /*: ?StepObject*/) /*: Promise<[number, number]>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].get_view_index(${config.variableMappingName}["${view.self.mapTo}"])`, false, step)
  }
  ...
  set_view_index (view /*: View*/, group /*: number*/, index /*: number*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_view_index(${config.variableMappingName}["${view.self.mapTo}"], ${group}, ${index})`, false, step)
  }
  ...
  status_message (string /*: string*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].status_message("""${string}""")`, false, step)
  }
  ...
  is_menu_visible (step /*: ?StepObject*/) /*: Promise<boolean>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].is_menu_visible()`, false, step)
  }
  ...
  set_menu_visible (flag /*: boolean*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    ...
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_menu_visible(${flagBool})`, false, step)
  }
  ...
  is_sidebar_visible (step /*: ?StepObject*/) /*: Promise<boolean>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].is_sidebar_visible()`, false, step)
  }
  ...
  set_sidebar_visible (flag /*: boolean*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    let flagBool = util.convertToPythonBool(flag)
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_sidebar_visible(${flagBool})`, false, step)
  }
  ...
  get_tabs_visible (step /*: ?StepObject*/) /*: Promise<boolean>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].get_tabs_visible()`, false, step)
  }
  ...
  set_tabs_visible (flag /*: boolean*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    let flagBool = util.convertToPythonBool(flag)
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_tabs_visible(${flagBool})`, false, step)
  }
  ...
  is_minimap_visible (step /*: ?StepObject*/) /*: Promise<boolean>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].is_minimap_visible()`, false, step)
  }
  ...
  set_minimap_visible (flag /*: boolean*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    let flagBool = util.convertToPythonBool(flag)
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_minimap_visible(${flagBool})`, false, step)
  }
  ...
  is_status_bar_visible (step /*: ?StepObject*/) /*: Promise<boolean>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].is_status_bar_visible()`, false, step)
  }
  ...
  set_status_bar_visible (flag /*: boolean*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    let flagBool = util.convertToPythonBool(flag)
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_status_bar_visible(${flagBool})`, false, step)
  }
  ...
  folders (step /*: ?StepObject*/) /*: Promise<Array<string>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].folders()`, false, step)
  }
  ...
  project_file_name (step /*: ?StepObject*/) /*: Promise<string>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].project_file_name()`, false, step)
  }
  ...
  project_data (step /*: ?StepObject*/) /*: Promise<Object>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].project_data()`, false, step)
  }
  ...
  set_project_data (data /*: Object*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].set_project_data(json.loads("""${JSON.stringify(data)}"""))`, false, step)
  }
  ...
  show_quick_panel (items /*: Array<string>*/, on_done /*: (number, ?StepObject) => void*/, flags /*: ?number*/ = 0, selected_index /*: number*/ = -1, on_highlighted /*: ?(number, ?StepObject) => void*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    ...
    let callbacks = []
    let code = `${config.variableMappingName}["${this.self.mapTo}"].show_quick_panel(json.loads("""${JSON.stringify(items)}"""), lambda index: sublime.set_timeout_async(lambda: callback($PORT_TOKEN, index)), ${flags}, ${selected_index}`
  ...
  show_input_panel (caption /*: string*/, initial_text /*: string*/, on_done /*: ?(string, ?StepObject) => void*/, on_change /*: ?(string, ?StepObject) => void*/, on_cancel /*: ?(?StepObject) => void*/, step /*: ?StepObject*/) /*: Promise<View>*/ {
    ...
    let callbacks = []
    let code = `${config.variableMappingName}["${this.self.mapTo}"].show_input_panel("""${caption}""", """${initial_text}""", lambda userInput: sublime.set_timeout_async(lambda: callback($PORT_TOKEN, userInput)), lambda userInput: sublime.set_timeout_async(lambda: callback($PORT_TOKEN, userInput)), lambda: sublime.set_timeout_async(lambda: callback($PORT_TOKEN)))`
  ...
  create_output_panel (name /*: string*/, unlisted /*: ?boolean*/ = false, step /*: ?StepObject*/) /*: Promise<View>*/ {
    ...
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].create_output_panel("""${name}""", ${unlistedBool})`, true, step, (result, resultObject) => {
      return new View(resultObject)
    })
  }
  ...
  find_output_panel (name /*: string*/, step /*: ?StepObject*/) /*: Promise<View | null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].find_output_panel("""${name}""")`, true, step, (result, resultObject) => {
      if (result == 'SublimeObject')
        return new View(resultObject)
      else
        return null
  ...
  destroy_output_panel (name /*: string*/, step /*: ?StepObject*/) /*: Promise<null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].destroy_output_panel("""${name}""")`, false, step)
  }
  ...
  active_panel (step /*: ?StepObject*/) /*: Promise<string | null>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].active_panel()`, false, step)
  }
  ...
  panels (step /*: ?StepObject*/) /*: Promise<Array<string>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].panels()`, false, step)
  }
  ...
  lookup_symbol_in_index (symbol /*: string*/, step /*: ?StepObject*/) /*: Promise<Array<[string, string, [number, number]]>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].lookup_symbol_in_index("""${symbol}""")`, false, step)
  }
  ...
  lookup_symbol_in_open_files (symbol /*: string*/, step /*: ?StepObject*/) /*: Promise<Array<[string, string, [number, number]]>>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].lookup_symbol_in_open_files("""${symbol}""")`, false, step)
  }
  ...
  extract_variables (step /*: ?StepObject*/) /*: Promise<Object>*/ {
    return util.simpleEval(`${config.variableMappingName}["${this.self.mapTo}"].extract_variables()`, false, step)
  }
